...
import { fetchLoginData } from '../../actionandReducers/loginReducer/action';
...
const SignIn = () => {
  ...
  const handleFormSubmit = useCallback(async () => {
    if (!signInState?.email || !signInState?.password) {
      return toast.error('Please fill all the values to proceed');
    }
    await dispatch(
      fetchLoginData({
  ...
  }, [dispatch, navigate, signInState?.email, signInState?.password]);

  return (
    <>
      <div className=" rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex  flex-wrap items-center">
          <div className=" hidden min-h-[100vh] w-full items-center xl:flex xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              <p className="text-[40px] font-[600] text-[#000]">Signs Admin</p>
              <p className="pt-[20px] 2xl:px-20">
          ...
          <div className="py-auto flex min-h-[100vh] w-full items-center border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Start for free</span>
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign In to SignsAdmin
              </h2>
