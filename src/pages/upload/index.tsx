  ...
  return (
    <>
      <div className="mx-auto max-w-[1290px]">
        <Breadcrumb pageName="Upload Product" />
              ...
              <div className="p-7">
                <form action="#">
                  ...
                  <div className="mb-5.5">
                    ...
                    <div
                      id="FileUpload"
                      className="relative mb-5.5 mt-5.5 block w-full cursor-pointer appearance-none rounded border-2 border-dashed border-primary bg-gray px-4 py-4 dark:bg-meta-4 sm:py-7.5"
                    >
                      <input
                        type="file"
                        accept="image/*"
